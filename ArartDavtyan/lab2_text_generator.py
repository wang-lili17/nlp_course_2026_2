# ============================================================
#  LSTM Text Generator — Trained on Frankenstein (Project Gutenberg)
#  Demonstrates language modeling with early stopping and
#  text generation at multiple temperature settings.
# ============================================================
...
class TextLSTM(nn.Module):
    ...
    def forward(self, x):
        ...
        last_out  = lstm_out[:, -1, :]        # take only the last timestep
